...
function numericHash(seed) {
    let s = seed ? crypto_1.default.buf2hex(seed) : (0, exports.sha256)(crypto_1.default.buf2hex((0, exports.randomBytes)(32)));
...
function randomStr(len = 32) {
    return crypto_1.default.buf2hex((0, exports.randomBytes)(32)).slice(0, 32);
}
exports.randomStr = randomStr;
function encrypt(params) {
    let d = (0, _1.encodeCoreData)(params.data);
    if (!d)
        return (0, _1.error)('encrypt needs data');
    const secret = Buffer.from((0, exports.sha256)(params.key), 'hex').slice(0, 32);
...
function decrypt(params) {
    ...
    return (0, _1.decodeCoreData)(decrypted_data);
}
...
async function generatePathAddress(params) {
    ...
    const level1 = params?.level1 || (0, _1.getRandomInt)(0, max_path);
    const level2 = params?.level2 || (0, _1.getRandomInt)(0, max_path);
