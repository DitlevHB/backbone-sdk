...
class IdManagerClass {
    ...
    async init() {
        ...
        if (ifr) {
            ...
            if (!pong)
                return (0, common_1.error)(`communication with Id failed`);
        }
        else
            return (0, common_1.error)(`couldn't initialize Id`);
    }
    async authenticate(params) {
        ...
        if (!popup || popup.closed || typeof popup.closed == 'undefined') {
            ...
            clearInterval(is_authenticated_check);
            return (0, common_1.error)(`couldn't open Id`);
        }
    }
    async isAuthenticated(params) {
        ...
        if (this.IdApp)
            ...
            return (0, common_1.error)(`no Id available`);
    }
